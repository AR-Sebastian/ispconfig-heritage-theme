...
**[HERITAGE 1.0.21 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.21 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.21](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
