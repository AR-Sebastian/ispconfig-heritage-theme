...
**[HERITAGE 1.0.27 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.27 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.27](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
