...
**[HERITAGE 1.0.3 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.3 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.3](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
