...
**[HERITAGE 1.0.25 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.25 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.25](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
