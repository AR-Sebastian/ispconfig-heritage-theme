...
**[HERITAGE 1.0.2 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.2 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.2](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
