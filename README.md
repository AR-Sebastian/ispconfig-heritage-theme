...
**[HERITAGE 1.0.6 herunterladen](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**

### Schnellstart

```bash
git clone --branch v1.0.6 --depth 1 https://github.com/AR-Sebastian/ispconfig-heritage-theme.git
...
**[Download HERITAGE 1.0.6](https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/latest)**
