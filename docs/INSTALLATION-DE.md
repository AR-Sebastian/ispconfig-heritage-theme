...
```bash
curl -fLO https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/download/v1.0.24/ispconfig-heritage-theme-1.0.24.tar.gz
curl -fLO https://github.com/AR-Sebastian/ispconfig-heritage-theme/releases/download/v1.0.24/SHA256SUMS.txt
sha256sum -c --ignore-missing SHA256SUMS.txt
sudo tar -xzf ispconfig-heritage-theme-1.0.24.tar.gz -C /usr/local/ispconfig/interface/web/themes/
```
