# ISPConfig HERITAGE 1.0.20

HERITAGE 1.0.20 completes the information hierarchy of responsive table cards.
...
duplication. The browser gate now proves this relationship together with action
geometry, overflow, colour modes and runtime stability.

## Previous releases

HERITAGE 1.0.18 removes a self-triggering content-observer cycle that could make
the authenticated interface progressively slow or unresponsive. Theme-owned DOM
enhancement is debounced and suspends observation during its own changes.
